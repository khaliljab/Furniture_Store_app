...
public class All_Categories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rating.add(4.5f);
        rating.add(2.5f);
        recyclerView.setLayoutManager(new GridLayoutManager(All_Categories.this,2));
        AdapterShowAll adapterShowAll= new AdapterShowAll(All_Categories.this,title,photo,price,rating);
